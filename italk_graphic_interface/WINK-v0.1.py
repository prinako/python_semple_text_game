...
class ChatPage(GridLayout):
   ...
   # def on_key_down1(self, instance, keyboard, keycode, text, modifiers):
    ...
    def mr_itolkRun(self):
        ...
        while k > 0:
            Clock.schedule_once(self.send_message, 0.1)
            ...
            if self.num in lista:
                ...
                if self.num == self.num2:
                    ...
                    self.history.update_chat_history(f'[color=20dd20]{name2}[/color] > [color=a499ec] chose: [/color]'
                                                     f' {num2str}')
                    ...
                    self.history.update_chat_history(f"> [color=d2d020] {name2} [/color] [color=a499ec] your score is:"
                                                     f" {str(s)} [/color]\n")
                    ...
                    self.history.update_chat_history(f"> [color=20dd20] {name2} [/color] [color=a499ec] You've won {y}"
                                                     f" point [/color]\n")
                ...
                if self.n == 4:
                    ...
                    self.history.update_chat_history(f"> [color=20dd20] {name2} [/color] [color=a499ec] your score is:"
                                                     f" {s} [/color]\n")
